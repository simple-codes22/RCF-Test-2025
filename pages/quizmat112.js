...
import { quizData } from "../constants/mat112";
...
const StartQuiz = ({ name, id }) => {
  ...
  const CountdownTimer = () => {
    const [countdown, setCountdown] = useState(900); // 900 seconds = 15 minutes
    useEffect(() => {
  ...
  return (
	<div className={styles.body}>
	  ...
	  <h3 className={styles.instruction}>MAT113: <em className={styles.ctitle}>Elementary Mathematics II</em></h3>
