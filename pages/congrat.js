...
//         const url = `http://localhost/rcf_db/save_score.php?username=${encodeURIComponent(entry.username)}&id=${encodeURIComponent(entry.id)}&score=${encodeURIComponent(entry.integerValue)}`;
...
//     <button className={styles.loginbtn} onClick={saveAllScores}>Save All Scores</button>
// 	</div>
//     </div>
...
//       <img className={styles.logo} onClick={() => window.location.href = "quizphy113"} src="rcf_logo_172_X_155.png" alt="RCF_Logo" width="48" height="48"/>
// 		<div className={styles.user_info}>
// 			<div className={styles.timer}>Ended
// 			{/* <CountdownTimer/> */}
//       {/* <p>status</p> */}
//       {/* <p>{autoSubmitted}</p> */}
// 			</div>
...
//       for (const entry of dataEntries) {
//         // Construct the URL with parameters
//         const url = `http://192.168.0.197/rcf_db/save_score.php?username=${encodeURIComponent(entry.username)}&id=${encodeURIComponent(entry.id)}&score=${encodeURIComponent(entry.integerValue)}`;
...
// 		  borderRadius: '4px'
// 		}}>Congratulation on the successful completion of your quiz</div>
//     <button className={styles.loginbtn} onClick={saveAllScores}>Close</button>
// 	</div>
//     </div>
  ...
  const saveAllScores = async () => {
    try {
      ...
      for (const entry of dataEntries) {
        ...
        const url = `http://${ipAddress}/rcf_db/save_score.php?username=${encodeURIComponent(entry.username)}&id=${encodeURIComponent(entry.id)}&score=${encodeURIComponent(btoa(entry.integerValue))}`;
