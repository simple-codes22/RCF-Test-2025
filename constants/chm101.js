export const quizData = {
  ...
  questions: [
    {
      question: "1. Who was the first person to use the word 'atom'?",
      options: ['JJ Thompson', 'Democritus', 'Niels Bohr', 'Ewin Schrodinger'],
      answer: 'Democritus'
    },
    {
      question: '2. Whose theory is called the theory of the universe?',
      options: ['Democritus', 'Niels Bohr', 'Ewin Schrodinger', 'None of the above'],
      answer: "Democritus"
    },
    {
      question: '3. All but one are assumptions of Democritus.',
      options: ['There is an empty space between atoms', 'Atoms are completely solid', 'Atoms consists of positive charge spheres', 'Atoms have no internal structure'],
      answer: 'Atoms consists of positive charge spheres'
    },
    {
      question: '4. The probability of finding the electrons in the orbitals is referred to as ______',
      options: ['Electron path way', 'Probability', 'Lobes', 'Projectile'],
      answer: 'Lobes'
    },
    {
